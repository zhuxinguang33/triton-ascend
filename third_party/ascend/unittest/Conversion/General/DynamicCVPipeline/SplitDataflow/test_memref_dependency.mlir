...
func.func @test_memref_dependency(%arg3: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg7: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 2 : i32}, %arg8: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 2 : i32}) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "mix", parallel_mode = "simd"} {
  ...
  scf.for %arg43 = %c0_i32 to %c8_i32 step %c1_i32  : i32 {
    scf.for %arg44 = %c0_i32 to %c8_i32 step %c1_i32  : i32 {
      ...
      %44 = bufferization.to_tensor %alloc restrict writable {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "VECTOR"} : memref<576xf16> to tensor<576xf16>
    ...
    scf.for %arg45 = %c0_i32 to %c8_i32 step %c1_i32 : i32 {
      ...
      %42 = bufferization.to_tensor %alloc_8 restrict writable {ssbuffer.block_id = 2 : i32, ssbuffer.core_type = "CUBE"} : memref<128x576xf16> to tensor<128x576xf16>
      ...
      %44 = bufferization.to_tensor %alloc restrict writable {ssbuffer.block_id = 8 : i32, ssbuffer.core_type = "CUBE"} : memref<576xf16> to tensor<576xf16>
    ...
    %42 = bufferization.to_tensor %alloc_8 restrict writable {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "VECTOR"} : memref<128x576xf16> to tensor<128x576xf16>
...
// CHECK: scf.for
// CHECK: scf.for
// CHECK: bufferization.materialize_in_destination %1 in writable %reinterpret_cast_2 {ssbuffer.block_id = 7 : i32, ssbuffer.core_type = "VECTOR", ssbuffer.crossCoreDeps = [0 : i32, 1 : i32], ssbuffer.memCrossDeps = [0 : i32, 1 : i32]} : (tensor<576xf16>, memref<576xf16, strided<[1], offset: ?>>) -> ()
...
// CHECK: scf.for
// CHECK: memref.copy %reinterpret_cast_0, %alloc_1 {ssbuffer.block_id = 2 : i32, ssbuffer.core_type = "CUBE", ssbuffer.crossCoreDeps = [0 : i32, 0 : i32], ssbuffer.memCrossDeps = [0 : i32, 0 : i32]} : memref<128x576xf16, strided<[?, 1], offset: ?>> to memref<128x576xf16>
// CHECK: bufferization.materialize_in_destination %2 in writable %reinterpret_cast_4 {ssbuffer.block_id = 8 : i32, ssbuffer.core_type = "CUBE", ssbuffer.crossCoreDeps = [1 : i32, 1 : i32], ssbuffer.memCrossDeps = [1 : i32, 1 : i32]} : (tensor<576xf16>, memref<576xf16, strided<[1], offset: ?>>) -> ()
...
// CHECK: memref.copy %reinterpret_cast, %alloc {ssbuffer.block_id = 5 : i32, ssbuffer.core_type = "VECTOR", ssbuffer.crossCoreDeps = [1 : i32, 0 : i32], ssbuffer.memCrossDeps = [1 : i32, 0 : i32]} : memref<128x576xf16, strided<[?, 1], offset: ?>> to memref<128x576xf16>
