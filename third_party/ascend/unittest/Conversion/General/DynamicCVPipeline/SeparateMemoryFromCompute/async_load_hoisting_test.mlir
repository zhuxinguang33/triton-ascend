...
func.func @test_gm_load_cube_marked(
  ...
  %to_tensor = bufferization.to_tensor %alloc {ssbuffer.block_id = 5 : i32} : memref<128x128xf16> to tensor<128x128xf16>
  ...
  // CHECK: bufferization.to_tensor
  // CHECK-SAME: gm_load_bufferable
  %to_tensor_2 = bufferization.to_tensor %alloc_2 {ssbuffer.block_id = 5 : i32} : memref<128x128xf16> to tensor<128x128xf16>
...
func.func @test_gm_load_mask_not_marked(
  ...
  %to_tensor = bufferization.to_tensor %alloc {ssbuffer.block_id = 7 : i32} : memref<128xf32> to tensor<128xf32>
...
func.func @test_gm_load_nonlinear_cast_not_marked(
  ...
  // CHECK-NOT: gm_load_bufferable
  %to_tensor = bufferization.to_tensor %alloc {ssbuffer.block_id = 8 : i32} : memref<32x128xf16> to tensor<32x128xf16>
  ...
  // CHECK-NOT: gm_load_bufferable
  %to_tensor_for = bufferization.to_tensor %for_result#1 {ssbuffer.block_id = 8 : i32} : memref<32x128xf16> to tensor<32x128xf16>
  ...
  // CHECK-NOT: gm_load_bufferable
  %to_tensor_while = bufferization.to_tensor %while_result#1 {ssbuffer.block_id = 8 : i32} : memref<32x128xf16> to tensor<32x128xf16>
  // ========== Feeds Cube compute ==========
...
func.func @test_gm_load_non_gm_source_not_marked(
  ...
  // CHECK-NOT: gm_load_bufferable
  %to_tensor = bufferization.to_tensor %alloc {ssbuffer.block_id = 26 : i32} : memref<32x256xf32> to tensor<32x256xf32>
...
func.func @test_gm_load_cross_block_marked(
  ...
  // CHECK: bufferization.to_tensor
  // CHECK-SAME: gm_load_bufferable
  %0 = bufferization.to_tensor %alloc {ssbuffer.block_id = 11 : i32} : memref<128x128xf16> to tensor<128x128xf16>
  return
}
