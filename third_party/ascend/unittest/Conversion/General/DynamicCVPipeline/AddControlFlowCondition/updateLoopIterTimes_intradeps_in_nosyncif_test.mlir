...
module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
  func.func @_attn_fwd(%arg0: memref<?xi8>, %arg1: memref<?xi8>, %arg2: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg4: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg5: memref<?xf32> {tt.divisibility = 16 : i32}, %arg6: memref<?xf32> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg7: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg8: memref<?xi32> {tt.divisibility = 16 : i32}, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "mix", parallel_mode = "simd"} {
    ...
    scope.scope : () -> () {
      ...
      %memspacecast_1 = memref.memory_space_cast %alloc_1 {} : memref<128xf32, #hivm.address_space<ub>> to memref<128xf32>
      %alloc_2 = memref.alloc() : memref<128xf32, #hivm.address_space<ub>>
      %memspacecast_2 = memref.memory_space_cast %alloc_2 {} : memref<128xf32, #hivm.address_space<ub>> to memref<128xf32>
      ...
      %30:2 = scf.for %arg16 = %c0_i32 to %c8192_i32 step %c128_i32 iter_args(%arg17 = %c0_i32, %arg18 = %c0_i32) -> (i32, i32)  : i32 {
        ...
        scf.if %cond {
          hivm.hir.copy ins(%tensor : tensor<128xf32>) outs(%memspacecast_1 : memref<128xf32>) {ssbuffer.block_id = 5 : i32, ssbuffer.intraDeps = [1 : i32, 1 : i32]}
        } else {
          hivm.hir.copy ins(%tensor : tensor<128xf32>) outs(%memspacecast_2 : memref<128xf32>) {ssbuffer.block_id = 5 : i32, ssbuffer.intraDeps = [1 : i32, 1 : i32]}
        ...
        scf.if %45 {
          ...
          hivm.hir.copy ins(%42 : tensor<128xf32>) outs(%memspacecast_9 : memref<128xf32>) {ssbuffer.block_id = 5 : i32, ssbuffer.intraDeps = [0 : i32, 1 : i32]}
        } {ssbuffer.block_id = 5 : i32}
        %comsumer = scf.if %45 -> (tensor<128xf32>) {
          %55 = bufferization.to_tensor %memspacecast_1 restrict writable : memref<128xf32> to tensor<128xf32>
          scf.yield %55 : tensor<128xf32>
        } else {
          %55 = bufferization.to_tensor %memspacecast_2 restrict writable : memref<128xf32> to tensor<128xf32>
          scf.yield %55 : tensor<128xf32>
        ...
        hivm.hir.copy ins(%reshape_40 : tensor<8x4x16x16xf16>) outs(%alloc_11 : memref<8x4x16x16xf16, #hivm.address_space<cbuf>>) {ssbuffer.block_id = 5 : i32, ssbuffer.transfer_id = 1 : i32, ssbuffer.crossCoreDeps = [1 : i32, 1 : i32]}
    ...
    scope.scope : () -> () {
      ...
      %30:2 = scf.for %arg16 = %c0_i32 to %c8192_i32 step %c128_i32 iter_args(%arg17 = %c0_i32, %arg18 = %c0_i32) -> (i32, i32)  : i32 {
        ...
        %48 = hivm.hir.convert_layout %alloc_11 output_shape [64, 128] {dstLayout = #hivm.data_layout<ND>, srcLayout = #hivm.data_layout<nZ>, ssbuffer.block_id = 2 : i32, ssbuffer.crossCoreDeps = [1 : i32, 0 : i32], ssbuffer.transfer_id = 1 : i32} : (memref<8x4x16x16xf16, #hivm.address_space<cbuf>>) -> memref<64x128xf16, #hivm.address_space<cbuf>>
        scf.yield %arg17, %arg18 : i32, i32
      } {ssbuffer.block_id = 9 : i32, ssbuffer.main_loop = 0 : i64}
      scope.return
